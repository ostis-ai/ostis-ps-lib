...
#include "agent/ActionFinishedSuccessfullyTestAgent.hpp"
#include "agent/ActionFinishedTestAgent.hpp"
#include "agent/ActionFinishedUnsuccessfullyTestAgent.hpp"
...
{
ScsLoader loader;
const std::string TEST_FILES_DIR_PATH = "../test-structures/";
...
void initialize(ScAgentContext & agentContext)
{
  ...
  agentContext.SubscribeAgent<ActionFinishedSuccessfullyTestAgent>();
  agentContext.SubscribeAgent<ActionFinishedTestAgent>();
  agentContext.SubscribeAgent<ActionFinishedUnsuccessfullyTestAgent>();
...
void shutdown(ScAgentContext & agentContext)
{
  ...
  agentContext.UnsubscribeAgent<ActionFinishedSuccessfullyTestAgent>();
  agentContext.UnsubscribeAgent<ActionFinishedTestAgent>();
  agentContext.UnsubscribeAgent<ActionFinishedUnsuccessfullyTestAgent>();
