 ...
 */
class NrelFromQuasybinaryLinkSemanticNeighbourhoodTranslator : public SemanticNeighbourhoodTranslator
{
public:
  explicit NrelFromQuasybinaryLinkSemanticNeighbourhoodTranslator(ScMemoryContext * context);
