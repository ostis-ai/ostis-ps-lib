...
{
NrelInQuasybinaryNodeTranslator::NrelInQuasybinaryNodeTranslator(
    ScMemoryContext * context)
  : StructureTranslator(context)
{
}

std::vector<std::string> NrelInQuasybinaryNodeTranslator::translate(ScAddr const & structAddr) const
{
